...
/* ===== pfod Command for Led ====
  pfodApp msg {.} --> {,<bg n><b><+7><r>~Led Control`0~V1|A<bg g><+4>`0~Led is ~~Off\On~}
*/
// Using Arduino Mega 256 and RedBear BLE Shield and BLEPeripheral library V0.2.0 
// Using Arduino V1.6.8 IDE
/* Code generated by pfodDesignerV2 V2.0.2030
...
#include <SPI.h>
// This sketch needs the BLEPeripheral library V0.2.0 from and compile using Arduino V1.6.8 IDE
// from https://github.com/sandeepmistry/arduino-BLEPeripheral
#include <BLEPeripheral.h>

// define pins for RedBeardLab BLE shield
#define BLE_REQ   9
#define BLE_RDY   8
#define BLE_RST   4
...
pfodParser parser("RB18"); // create a parser to handle the pfod messages
